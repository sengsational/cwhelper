...
public class Emailer extends TimedEvent {
    ...
    public void sendTestMessage() {
        ...
        try {
            ...
            if (atLoc > -1 && !logonUser.endsWith("@")){
                ...
                System.out.println(new Date() + " ERROR: You have specified a logonUser without an '@'.  Using your machine name as send from domain." );
            }
    ...
    public void send() {
        ...
        try {
            ...
            String recentWebCaptures = cm.getRecentWebCapturesList(24);
            String scheduledWebCaptures = tm.getWebCapturesList();
            ...
            System.out.println(new Date() + " ERROR sending status email.  " + e.getMessage());
        }
