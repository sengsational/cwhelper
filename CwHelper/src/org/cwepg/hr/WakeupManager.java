...
import org.cwepg.svc.Kernel32.FILETIME;
import org.cwepg.svc.Kernel32.SECURITY_ATTRIBUTES;
import org.cwepg.svc.W32API.HANDLE;
...
public class WakeupManager {
    ...
    public static void allowSleep() {
        System.out.print(new Date() + " set to allow machine to sleep. ");
