  ...
  <Program>
    ...
    public ChannelDigital(String hdhrXml, String airCatSource, String xmlFileName, Tuner tuner, double priority) {
        ...
        if (dotLoc > 0 && dotLoc < this.channelVirtual.length()) {
            ...
            this.virtualSubchannel = Integer.parseInt(this.channelVirtual.substring(dotLoc + 1));
        }
    }
    ...
    public boolean equals(Object otherChannel) {
        if (otherChannel instanceof ChannelDigital) {
            ...
            return this.channelKey.equals(((Channel) otherChannel).channelKey)
                    && this.getFullVirtualChannel().equals(((Channel) otherChannel).getFullVirtualChannel())
    ...
    public int compareTo(Object otherChannel) {
        if (otherChannel instanceof ChannelDigital) {
            ...
            return (oc.channelKey + oc.getFullVirtualChannel()).compareTo(this.channelKey + this.getFullVirtualChannel());
        }
        return -1;
    }
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (testingHdhrXml) {
            ...
            Channel channel = new ChannelDigital(buf.toString(), "Digital Antenna", "Digital Antenna", new TunerHdhr("10119D6F-1", true),  1000);
        ...
        if (testingWebData) {
            ...
            System.out.println("full virtual:" + channelDigital.getFullVirtualChannel());
