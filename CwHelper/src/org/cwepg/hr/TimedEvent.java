...
public class TimedEvent {
    ...
    public boolean isDue() {
        // Don't send two back-to-back in the same 5 minutes
        long nowMs = new Date().getTime();
        if ((nowMs - lastTriggerMs) < 300000){
            System.out.println(new Date() + " Returning 'false' to isDue() " + triggerHour + ":" + triggerMinute + " because it's been less than 5 minutes since the last one ran.");
    ...
    public void setWakeup(String who) {
