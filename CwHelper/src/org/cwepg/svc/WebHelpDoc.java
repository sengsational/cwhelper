...
public class WebHelpDoc {
    ...
    static {
        ...
        buf.append("<tr><td>/set</td><td>endfusionwatch</td><td>ie true</td><td>Use to end Fusion watch events by putting a tiny capture at the end.  Default is false.</td></tr>\n");
        ...
        buf.append("<tr><td>/recent</td><td>-</td><td>-</td><td>Get a list of recent captures.</td></tr>\n");
