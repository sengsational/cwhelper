...
public class WebHelpDoc {
    ...
    static {
        ...
        buf.append("<tr><td>-</td><td>tuner</td><td>ie 1010CC54-0 or myhd</td><td>You use whatever the discover command replies with or \"myhd\". If this parameter is specified as an asterisk with an HDHR tuner, multiple back-to-back recordings will be scheduled for that channel on every tuner.  The purpose of this is to test reception for people who have antennas connected to their HDHR units.</td></tr>\n");
