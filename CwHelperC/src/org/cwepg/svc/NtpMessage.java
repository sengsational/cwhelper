...
public class NtpMessage
{
    ...
    public static long getLocalClockOffsetSeconds(String serverName, String message) throws Exception {
        ...
        // Process response
        //System.out.println("NTP datagram being processed...\n");
        ...
        //String timeStampString =  NtpMessage.timestampToString(destinationTimestamp);
        
        //System.out.println("Round-trip delay: " +  new DecimalFormat("0.00").format(roundTripDelay*1000) + " ms");
        
        System.out.println(new Date() + " " + message + " Local clock offset: " + new DecimalFormat("0.00").format(localClockOffset*1000) + " ms");
        
        socket.close();
        
        //System.out.println(new Date() + " We got this back from the time server: " + new Date((long)destinationTimestamp));
        //System.out.println(new Date() + " OUR PC says                          : " + new Date());
        //System.out.println(new Date() +  "Destination timestamp string:          " + timeStampString);
        
        //SimpleDateFormat sdf = new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss.SSSSSS");
        
        return (long)localClockOffset;    
    }
}   