...
public interface Advapi32  extends StdCallLibrary {
  Advapi32 INSTANCE = (Advapi32) Native.loadLibrary("Advapi32", Advapi32.class, W32APIOptions.DEFAULT_OPTIONS);
...
LONG WINAPI RegCreateKeyEx(
  ...
  public int RegCreateKeyEx(int hKey, String lpSubKey, int Reserved, String lpClass, int dwOptions, 
          int samDesired, SECURITY_ATTRIBUTES lpSecurityAttributes, IntByReference phkResult,
...
LONG WINAPI RegEnumKeyEx(
  ...
  public int RegEnumKeyEx(int hKey, int dwIndex, char[] lpName, IntByReference lpcName, IntByReference reserved,
          char[] lpClass, IntByReference lpcClass, FILETIME lpftLastWriteTime);
